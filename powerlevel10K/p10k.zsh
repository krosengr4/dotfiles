# Generated by Powerlevel10k configuration wizard on 2026-01-19 at 22:38 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=5
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=118
  ...
  source "${${(%):-%x}:h}/.p10k.ghostty-themes.zsh"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTI
  ...
  # Custom logo segment - displays a cool icon at the start of the prompt
  function prompt_custom_logo() {
    ...
    # local icon='◈'    # Diamond with lines
    # local icon='▣'    # Square with fill
    # local icon=''      # Apple logo (Nerd Font)

    # Multi-character custom logo examples:
    # local icon='▓▒░'   # Gradient blocks
    # local icon='◢◣'    # Chevron/mountain
    # local icon='⟨⟩'    # Angle brackets
    # local icon='【】'   # Japanese brackets

    # ASCII art examples (will show as text, not icon):
    # local icon='[K]'   # Your initial
    # local icon='>>>'   # Arrows

    # Colors: -b for background, -f for foreground
  ...
  function instant_prompt_custom_logo() {
    prompt_custom_logo
  }

  # Customize the logo segment colors
  typeset -g POWERLEVEL9K_CUSTOM_LOGO_FOREGROUND=255  # white
  typeset -g POWERLEVEL9K_CUSTOM_LOGO_BACKGROUND=237  # dark gray
